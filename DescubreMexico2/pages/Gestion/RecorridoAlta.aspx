<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite.Master" AutoEventWireup="true" CodeBehind="RecorridoAlta.aspx.cs" Inherits="DescubreMexico2.pages.Gestion.RecorridoAlta" %>
            ...
            <div class="col-lg-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Alta de Recorrido</h5>
                    </div>
                    <div class="card-body">
